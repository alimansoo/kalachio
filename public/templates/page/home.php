<main class="content">
        ...
        <div class="row d-flex flex-wrap align-content-center justify-space-evenly mb-4">
            ...
            <div class="sm-info"><a href=""><img src="store/sm2.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm3.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm4.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm5.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm6.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm7.png" alt="">لینک</a></div>
            <div class="sm-info"><a href=""><img src="store/sm7.png" alt="">لینک</a></div>
        </div>
        <div class="row">
            <div class="bg-primary text-white p-all-1">
                ...
                <div class="d-flex">
                    <div class="small-card">
                        <img src="img/p1.jpg" alt="" class="small-card_img">
                        <div class="small-card_body">
                            ...
                            <t6 class="small-card_body_curent">1,050,000</t6>
                        </div>
                    </div>
                    <div class="small-card">
                        <img src="img/p1.jpg" alt="" class="small-card_img">
                    ...
                    <div class="small-card">
                        <img src="img/p2.jpg" alt="" class="small-card_img">
                        <div class="small-card_body">
                        <span class="badge badge-small badge-top-left badge-pill badge-primary">20%</span>
                            <t5 class="small-card_body_new">1,000,000</t5>
                            <t6 class="small-card_body_curent">1,050,000</t6>
                    ...
                    <div class="small-card">
                        <img src="img/p3.jpg" alt="" class="small-card_img">
                        <div class="small-card_body">
                        <span class="badge badge-small badge-top-left badge-pill badge-primary">20%</span>
                            <t5 class="small-card_body_new">1,000,000</t5>
                            <t6 class="small-card_body_curent">1,050,000</t6>
                    ...
                    <div class="small-card">
                        <img src="img/p4.jpg" alt="" class="small-card_img">
                        <div class="small-card_body">
                            <span class="badge badge-small badge-top-left badge-pill badge-primary">20%</span>
                            <t5 class="small-card_body_new">1,000,000</t5>
                            <t6 class="small-card_body_curent">1,050,000</t6>
